<template>
  <view class="page-common">
    <user-bar />
    <menu-item-text class="page-title" icon-src="../../images/menu-dices/online-dice.svg" btn-color="#CE3F3F">在线匹配</menu-item-text>
    <view class="flex-fill config-area">
      ...
      <text class="menu-btn-border start-btn">开始游戏</text>
    </view>
